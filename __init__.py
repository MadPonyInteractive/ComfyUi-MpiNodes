...
NODE_CLASS_MAPPINGS = {
    ...
    "MpiLoadImage": MpiLoadImage,
    "MpiCrop": MpiCrop,
    "MpiImageSplice": MpiImageSplice,
    "MpiMaskSquareBbox": MpiMaskSquareBbox,
    "MpiMaskBbox": MpiMaskBbox,
    "MpiMaskFillHoles": MpiMaskFillHoles,
    "MpiBox": MpiBox,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "MpiLoadImage": "Mpi Load Image",
    "MpiCrop": "Mpi Crop",
    "MpiImageSplice": "Mpi Image Splice",
    "MpiMaskSquareBbox": "Mpi Mask Square Bbox",
    "MpiMaskBbox": "Mpi Mask Bbox",
    "MpiMaskFillHoles": "Mpi Mask Fill Holes",
    "MpiBox": "Mpi Box",
